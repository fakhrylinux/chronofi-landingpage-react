    ...
    <section className="page-section" id="about">
      <div className="container about">
        <div className="text-center d-flex flex-column">
          <div className="d-flex justify-content-center mt-2 button-section">
          ...
          <div className="row px-0">
            ...
            <div
              ...
              <p
                className="text-start text-white mt-2 align-middle"
                id="what-is"
              >
                <span className="chronofitext">CHRONOFi</span> is the first 2D &
                ...
                <br/><br/>
                Allowing <span className="chronofitext">CHRONOFi</span>
